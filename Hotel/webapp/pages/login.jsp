...
<head>
	...
	<link rel="stylesheet" href="<%=contextPath%>/css/footer&cbl.css" />
	<link rel="stylesheet" href="<%=contextPath%>/css/daohang.css" />
	...
	<script type="text/javascript" src="<%=contextPath%>/js/templet.js" ></script>
	<script type="text/javascript" src="<%=contextPath%>/js/hp.js" ></script>
	<title>登录界面</title>
</head>
<style>
	.main{
