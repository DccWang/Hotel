    ...
    <div class="bright">
        ...
        <div class="kbox">
            <form action="${pageContext.request.contextPath}/order/addOrder" method="post">
                ...
                <input type="hidden" value="${sessionScope.member1.mid}" name="memberId">
                <table border="1">
                    <tr>
                    ...
                    <tr>
                        <td>住客姓名</td>
                        <td>${sessionScope.member1.realName}</td>
                    </tr>
                    <tr>
                        <td>身份证号</td>
                        <td>${sessionScope.member1.identificationNum}</td>
                    </tr>
                    <tr>
                        <td>联系手机</td>
                        <td>${sessionScope.member1.telephone}</td>
                    </tr>
                    <tr>
                        <td>房间号</td>
