                ...
                <div class="panel panel-default mytab">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-10 data text">
                            <input type="text" name="houseNum" id="houseNum" value="${house.houseNum}">
...
<%--                            <input type="text" name="houseName" value="${house.houseName}">--%>
                                ...
                                <select name="houseName">
                                    <option selected>${house.houseName}</option>
...
<%--                            <input type="text" name="houseState"value="${house.houseState}" >--%>
                                ...
                                <select name="houseState">
                                    <option selected>${house.houseState}</option>
                        ...
                        <div class="col-md-10 data text">
                            <input type="text" name="housePrice" id="housePrice" value="${house.housePrice}" >
