...
<%--                                    <td><input name="ids" type="checkbox"></td>--%>
                                    ...
                                    <td class="text-center">
                                        <c:if test="${house.houseState eq '预订'}">
                                            <button type="button" disabled class="btn bg-olive btn-xs" onclick='location.href="${pageContext.request.contextPath}/house/findHouseById?id=${house.hid}"'>修改</button>
                                        </c:if>
                                        <c:if test="${house.houseState eq '住人'}">
                                            <button type="button" disabled class="btn bg-olive btn-xs" onclick='location.href="${pageContext.request.contextPath}/house/findHouseById?id=${house.hid}"'>修改</button>
                                        </c:if>
                                        <c:if test="${house.houseState eq '空房'}">
                                        ...
                                        <c:if test="${house.houseState eq '脏房'}">
                                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${pageContext.request.contextPath}/house/findHouseById?id=${house.hid}"'>修改</button>
                                        </c:if>
                                        <c:if test="${house.houseState eq '禁用'}">
                                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${pageContext.request.contextPath}/house/findHouseById?id=${house.hid}"'>修改</button>
                                        </c:if>
<%--                                        <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${pageContext.request.contextPath}/house/updateToVacantByJy?id=${house.hid}"'>删除</button>--%>




                                        <c:if test="${house.houseState == '空房'}">
<%--                                            <div class="quxiao" style="background: #aaa;">禁用</div>--%>
<%--                                            <div class="quxiao" style="background: red;"><a href="${pageContext.request.contextPath}/house/updateToVacantByJy?id=${house.hid}">禁用</a></div>--%>
                                            <div class="quxiao" style="background: red;"><a href="javascript:del('${house.hid}')">禁用</a></div>

                                        </c:if>
                                        <c:if test="${house.houseState == '脏房'}">
<%--                                            <div class="quxiao" style="background: red;"><a href="${pageContext.request.contextPath}/house/updateToVacantByJy?id=${house.hid}">禁用</a></div>--%>
                                            <div class="quxiao" style="background: red;"><a href="javascript:del('${house.hid}')">禁用</a></div>
                                        </c:if>
                                        <c:if test="${house.houseState == '预订'}">
                                            <div class="quxiao" style="background: #aaa;">禁用</div>
                                        </c:if>
                                        <c:if test="${house.houseState == '住人'}">
                                            <div class="quxiao" style="background: #aaa;">禁用</div>
                                        </c:if>
                                        <c:if test="${house.houseState == '禁用'}">
                                            <div class="quxiao" style="background: green;"><a href="${pageContext.request.contextPath}/house/updateToVacantByQy?id=${house.hid}">启用</a></div>
                                        </c:if>
                                    </td>
                                </tr>
                            </c:forEach>
                        ...
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" var="i" end="${pageInfo.pages}">
                                ...
                                <c:if test="${pageInfo.pageNum == i}">
                                    <li class="active"><a href="${pageContext.request.contextPath}/house/findAllByPage?page=${i}&size=${pageInfo.pageSize}">${i}</a></li>
                                </c:if>
                                <c:if test="${pageInfo.pageNum != i}">
                                    <li><a href="${pageContext.request.contextPath}/house/findAllByPage?page=${i}&size=${pageInfo.pageSize}">${i}</a></li>
                                </c:if>
...
<script>
    ...
    function del(id) {
        if (confirm("确认禁用该房间吗?")){
            location.href="${pageContext.request.contextPath}/house/updateToVacantByJy?id="+id;
        }
    }
