...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="${pageContext.request.contextPath}/userInfo/updateById" id="fr" method="post">
                <div class="panel panel-default mytab">
                    <div class="panel-heading">修改工作人员信息</div>
                    <div class="row data-type">
                        <input type="hidden" value="${user.id}" name="id">
                        <div class="col-md-2 title">用户名:</div>
                        <div class="col-md-10 data text">
                            <input type="text" value="${user.username}" id="name" name="username" readonly>
                        </div>
