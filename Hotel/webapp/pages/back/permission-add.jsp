...
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a href="${pageContext.request.contextPath}/per/findAll.do">资源权限管理</a></li>
				<li class="active">资源权限表单</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

			<form action="${pageContext.request.contextPath}/per/addPer"
				method="post" id="fr">
				<!-- 正文区域 -->
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" id="perName" class="form-control" name="permissionName"
				...
				<div class="box-tools text-center">
					<button type="submit" id="submit" class="btn bg-maroon">保存</button>
	...
	<script>
		$("#submit").click(function () {
			...
			var flagn = flag.test(perName);
			var flagu = flag.test(url);
