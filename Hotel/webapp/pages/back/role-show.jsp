                    ...
                    <div class="table-box">
                        ...
                        <div class="tab-pane" id="tab-treetable">
                            <table id="collapse-table"
                                ...
                                <tbody>
                                <c:forEach items="${role.permissions}" var="pe" varStatus="vs1">
                                    <tr data-tt-id="${vs1.index+1}" data-tt-parent-id="0">
                                        <td>${pe.permissionName }</td>
                                        <td>${pe.url }</td>
                                        <td class="text-center">
                                            <a href="${pageContext.request.contextPath}/role/delPerAndRole?roleid=${role.id}&permissionid=${pe.id}" class="btn bg-olive btn-xs">删除权限</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
