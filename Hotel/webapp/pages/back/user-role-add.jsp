	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a href="${pageContext.request.contextPath}/userInfo/findAll.do">用户管理</a></li>
			...
			<form
				action="${pageContext.request.contextPath}/userInfo/addRoleById"
				method="post" id="fr">
				<!-- 正文区域 -->
							...
							<tbody>
								<c:forEach items="${role}" var="role">
									<tr>
										...
										<input name="ids" id="ids" type="checkbox" value="${role.id}">
