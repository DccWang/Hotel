...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/userInfo/addUserInfo" id="from"
				method="post">
				<!-- 正文区域 -->
	...
	<script>
		...
		$("#submit").click(function () {
			...
			var regname=/^[a-zA-Z0-9]{2,4}$/;
			var nameflag = regname.test(username);

			//密码验证
			var password = $("#password").val();
			var regpassword = /^[a-zA-Z0-9]{6,14}$/;
